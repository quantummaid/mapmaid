...
import static de.quantummaid.mapmaid.builder.customtypes.serializedobject.duplex.SerializedObjectBuilder2.serializedObjectBuilder2;
...
public final class SerializedObjectBuilder1<X, A> {
    ...
    public DuplexType<X> deserializedUsing(final Deserializer1<X, A> deserializer) {
