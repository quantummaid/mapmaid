...
import static de.quantummaid.mapmaid.builder.customtypes.serializedobject.duplex.SerializedObjectBuilder5.serializedObjectBuilder5;
...
public final class SerializedObjectBuilder4<X, A, B, C, D> {
    ...
    public DuplexType<X> deserializedUsing(final Deserializer4<X, A, B, C, D> deserializer) {
