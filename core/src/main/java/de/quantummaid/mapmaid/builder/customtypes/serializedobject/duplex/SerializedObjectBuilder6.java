...
import static de.quantummaid.mapmaid.builder.customtypes.serializedobject.duplex.SerializedObjectBuilder7.serializedObjectBuilder7;
...
public final class SerializedObjectBuilder6<X, A, B, C, D, E, F> {
    ...
    public DuplexType<X> deserializedUsing(final Deserializer6<X, A, B, C, D, E, F> deserializer) {
