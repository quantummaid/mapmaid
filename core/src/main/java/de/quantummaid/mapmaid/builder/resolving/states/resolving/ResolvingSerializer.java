...
import static de.quantummaid.mapmaid.builder.resolving.states.resolved.ResolvedSerializer.resolvedSerializer;
...
public final class ResolvingSerializer extends StatefulSerializer {
    ...
    public static ResolvingSerializer resolvingSerializer(final Context context) {
