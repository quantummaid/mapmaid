...
import de.quantummaid.mapmaid.builder.customtypes.serializedobject.Deserializer4;
...
import static de.quantummaid.mapmaid.builder.customtypes.serializedobject.deserialization_only.SerializedObjectBuilder5.serializedObjectBuilder5;
...
public final class SerializedObjectBuilder4<X, A, B, C, D> {
    ...
    public DeserializationOnlyType<X> deserializedUsing(final Deserializer4<X, A, B, C, D> deserializer) {
