...
import static de.quantummaid.mapmaid.builder.builder.serializedobject.Builder.emptyBuilder;
import static de.quantummaid.mapmaid.builder.builder.serializedobject.SerializedObjectBuilder1.serializedObjectBuilder1;
