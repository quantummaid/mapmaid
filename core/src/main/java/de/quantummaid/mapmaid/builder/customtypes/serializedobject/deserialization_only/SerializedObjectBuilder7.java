...
import de.quantummaid.mapmaid.builder.customtypes.serializedobject.Deserializer7;
...
public final class SerializedObjectBuilder7<X, A, B, C, D, E, F, G> {
    ...
    public DeserializationOnlyType<X> deserializedUsing(final Deserializer7<X, A, B, C, D, E, F, G> deserializer) {
