...
import de.quantummaid.mapmaid.builder.customtypes.serializedobject.Deserializer1;
...
import static de.quantummaid.mapmaid.builder.customtypes.serializedobject.deserialization_only.SerializedObjectBuilder2.serializedObjectBuilder2;
...
public final class SerializedObjectBuilder1<X, A> {
    ...
    public DeserializationOnlyType<X> deserializedUsing(final Deserializer1<X, A> deserializer) {
