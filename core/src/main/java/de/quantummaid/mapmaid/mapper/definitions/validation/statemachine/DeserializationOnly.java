...
public final class DeserializationOnly implements DefinitionRequirements {

    public static DeserializationOnly deserializationOnly() {
        return new DeserializationOnly();
    }
