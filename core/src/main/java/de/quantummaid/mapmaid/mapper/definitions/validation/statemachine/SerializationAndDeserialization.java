...
public final class SerializationAndDeserialization implements DefinitionRequirements {

    public static SerializationAndDeserialization serializationAndDeserialization() {
        return new SerializationAndDeserialization();
    }
