...
package de.quantummaid.mapmaid.dynamodb.util.localdynamodb;
...
import static de.quantummaid.mapmaid.dynamodb.util.basedirectory.BaseDirectoryFinder.findProjectBaseDirectory;
import static de.quantummaid.mapmaid.dynamodb.util.localdynamodb.LocalDynamoDbException.localDynamoDbException;
...
public final class LocalDynamoDb implements AutoCloseable {
    private static final String NATIVE_LIBS_DIRECTORY = "/integrations/dynamodb/native-libs";
