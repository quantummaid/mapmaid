...
package de.quantummaid.mapmaid.json.withPrimitives;
...
public final class WithPrimitivesBuilderTests {
    ...
    private static final MapMaid MAP_MAID = MapMaid.aMapMaid()
            .serializingAndDeserializing(SerializedObjectWithPrimitives.class)
