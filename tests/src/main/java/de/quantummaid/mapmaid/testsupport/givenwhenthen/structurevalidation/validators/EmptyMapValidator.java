...
public final class EmptyMapValidator implements StructureValidator {

    public static StructureValidator emptyMap() {
        return new EmptyMapValidator();
    }
    ...
    public StructureValidations validate(final Object object) {
        ...
        if (!map.isEmpty()) {
            return validation("map not empty");
        } else {
            return ok();
        }
    }
