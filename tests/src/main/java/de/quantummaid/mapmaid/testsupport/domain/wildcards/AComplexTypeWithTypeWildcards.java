...
public final class AComplexTypeWithTypeWildcards {
    ...
    public static AComplexTypeWithTypeWildcards deserialize(final List<? super Integer> wildcardedList) {
        return new AComplexTypeWithTypeWildcards(wildcardedList);
    }
}
