...
public interface StructureValidator {
    ...
    StructureValidations validate(Object object);

    Object mutableSample();

    default void runValidation(final Object object) {
        final StructureValidations validations = validate(object).rebase("$");
