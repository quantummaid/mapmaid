...
public final class KotlinBasedCustomPrimitiveExample {

    @Test
    public void kotlinBasedCustomPrimitiveExample() {
        scenarioBuilderFor(KotlinCustomPrimitive.class)
                .withSerializedForm("\"abcdefg\"")
