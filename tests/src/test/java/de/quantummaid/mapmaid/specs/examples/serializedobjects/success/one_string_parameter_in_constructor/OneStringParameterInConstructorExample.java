...
public final class OneStringParameterInConstructorExample {

    @Test
    public void mixedGetterFactoryExample() {
        scenarioBuilderFor(UseCaseResponseKotlin.class)
                .withSerializedForm("" +
                        "{\n" +
                        "  \"payload\": {\n" +
                        "    \"lastName\": \"c\",\n" +
                        ...
                        "  \"correlationId\": \"a\"\n" +
                        "}")
                .withDeserializedForm(new UseCaseResponseKotlin("a", new UserDtoKotlin(new FirstName("b"), new LastName("c"))))
