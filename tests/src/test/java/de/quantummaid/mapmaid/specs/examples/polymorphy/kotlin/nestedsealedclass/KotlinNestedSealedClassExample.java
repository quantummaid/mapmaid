...
public final class KotlinNestedSealedClassExample {
    ...
    public void kotlinSealedClassExample() {
        scenarioBuilderFor(MyKotlinSealedClass.class)
                .withSerializedForm("" +
                        "{" +
                        "\"_type\":\"de.quantummaid.mapmaid.specs.examples.polymorphy.kotlin.nestedsealedclass.MyKotlinSealedSubclass\"," +
                        "\"type\":\"de.quantummaid.mapmaid.specs.examples.polymorphy.kotlin.nestedsealedclass.KotlinSealedSubclass1\"," +
                        "\"field1\":\"foo\"," +
                        "\"field2\":\"bar\"" +
                        "}")
