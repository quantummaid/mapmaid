...
package de.quantummaid.mapmaid.specs.examples.serializedobjects.success.symetric.list_to_array;
...
public final class ListToArrayExample {
    ...
    public void listToArrayExample() {
        scenarioBuilderFor(ARequest.class)
                .withSerializedForm("{\n" +
                        ...
                        "  ]\n" +
                        "}")
                .withDeserializedForm(ARequest.aRequest(List.of(Name.fromStringValue("foo"))))
