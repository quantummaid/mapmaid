...
package de.quantummaid.mapmaid.specs.examples.serializedobjects.success.serialization_only.example1;
...
public final class SerializationOnlyExample {
    ...
    public void serializationOnlyExample() {
        scenarioBuilderFor(AddPersonDto.class)
                .withSerializedForm("{\n" +
                        "  \"name\": \"asdf\"\n" +
                        "}")
                .withDeserializedForm(AddPersonDto.init())
