...
public final class AddALotRequest {
    ...
    public static AddALotRequest factory1(final Name name,
    ...
    public static AddALotRequest factory2(final Name name,
                                          final TownName townNameA,
                                          final TownName townNameB,
                                          final TownName townNameC) {
        return new AddALotRequest(name, townNameA, townNameB, townNameC);
    ...
    public static AddALotRequest factory3(final Name name,
                                          final TownName townNameA) {
        return new AddALotRequest(name, townNameA, null, null);
    }
}
