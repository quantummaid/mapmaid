...
package de.quantummaid.mapmaid.specs.examples.customprimitives.success.constructor;
...
public final class ConstructorExample {
    ...
    public void constructorExample() {
        scenarioBuilderFor(ConstructorCustomPrimitive.class)
                .withSerializedForm("\"foo\"")
                .withDeserializedForm(new ConstructorCustomPrimitive("foo"))
