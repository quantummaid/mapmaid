...
package de.quantummaid.mapmaid.specs.examples.special.local_class;
...
public final class LocalClassExample {
    ...
    public void localClassExample() {
        ...
        scenarioBuilderFor(LocalClass.class)
                ...
                .withSerializationFailing("type 'de.quantummaid.mapmaid.specs.examples.special.local_class.LocalClassExample$1LocalClass' " +
                        "cannot be detected because it is a local class (you can still register it manually)")
                .withDeserializationFailing("type 'de.quantummaid.mapmaid.specs.examples.special.local_class.LocalClassExample$1LocalClass' " +
                        "cannot be detected because it is a local class (you can still register it manually)")
