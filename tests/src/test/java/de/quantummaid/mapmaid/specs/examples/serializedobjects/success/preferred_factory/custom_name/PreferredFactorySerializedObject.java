...
package de.quantummaid.mapmaid.specs.examples.serializedobjects.success.preferred_factory.custom_name;
...
public final class PreferredFactorySerializedObject {
    ...
    public static PreferredFactorySerializedObject myCustomName(final String value1,
                                                                final String value2,
                                                                final String value3,
                                                                final String value4) {
