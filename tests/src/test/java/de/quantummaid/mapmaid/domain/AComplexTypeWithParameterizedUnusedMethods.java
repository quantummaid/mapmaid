...
public final class AComplexTypeWithParameterizedUnusedMethods {
    public final AString stringA;
    public final AString stringB;
    public final ANumber number1;
    public final ANumber number2;

    public static AComplexTypeWithParameterizedUnusedMethods deserialize(final AString stringA,
                                                                         final AString stringB,
                                                                         final ANumber number1,
                                                                         final ANumber number2) {
        return new AComplexTypeWithParameterizedUnusedMethods(stringA, stringB, number1, number2);
    }
