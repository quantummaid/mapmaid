...
package de.quantummaid.mapmaid.docs.examples.serializedobjects.success.getter_and_public_fields;

import org.junit.jupiter.api.Test;

import static de.quantummaid.mapmaid.docs.examples.system.ScenarioBuilder.scenarioBuilderFor;

public final class GetterAndPublicFieldsExample {

    @Test
    public void getterAndPublicFieldsExample() {
        scenarioBuilderFor(GetterAndPublicFieldsSerializedObject.class)
                .withSerializedForm("" +
                        "{\n" +
                        "  \"fieldA\": \"a\",\n" +
                        "  \"fieldC\": \"c\",\n" +
