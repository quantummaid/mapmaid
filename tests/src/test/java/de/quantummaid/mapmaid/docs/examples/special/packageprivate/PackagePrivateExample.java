...
package de.quantummaid.mapmaid.docs.examples.special.packageprivate;

import org.junit.jupiter.api.Test;

import static de.quantummaid.mapmaid.builder.customtypes.DuplexType.customPrimitive;
import static de.quantummaid.mapmaid.docs.examples.special.packageprivate.PackagePrivateClass.packagePrivateClass;
...
public final class PackagePrivateExample {
    ...
    public void packagePrivateExample() {
        scenarioBuilderFor(PackagePrivateClass.class)
                ...
                .withSerializationFailing("type 'de.quantummaid.mapmaid.docs.examples.special.packageprivate.PackagePrivateClass' " +
                        "cannot be detected because it is not public (you can still register it manually)")
                .withDeserializationFailing("type 'de.quantummaid.mapmaid.docs.examples.special.packageprivate.PackagePrivateClass' " +
                        "cannot be detected because it is not public (you can still register it manually)")
                .withDuplexFailing("type 'de.quantummaid.mapmaid.docs.examples.special.packageprivate.PackagePrivateClass' " +
                        "cannot be detected because it is not public (you can still register it manually)")
