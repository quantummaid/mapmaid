...
package de.quantummaid.mapmaid.docs.examples.serializedobjects.success.transient_field_with_getter;
...
public final class TransientFieldWithGetterExample {

    @Test
    public void transientFieldWithGetterExample() {
        final AddALotRequest addALotRequest = new AddALotRequest();
        addALotRequest.setName(Name.fromStringValue("foo"));
        addALotRequest.setTownName(TownName.townName("bar"));
