...
public final class AnnotationExample {
    ...
    public void annotationExample() {
        ...
        scenarioBuilderFor(Annotation.class)
                ...
                .withSerializationFailing("type 'de.quantummaid.mapmaid.docs.examples.special.annotation.Annotation' " +
                        "cannot be detected because it is an annotation (you can still register it manually)")
                .withDeserializationFailing("type 'de.quantummaid.mapmaid.docs.examples.special.annotation.Annotation' " +
                        "cannot be detected because it is an annotation (you can still register it manually)")
                .withDuplexFailing("type 'de.quantummaid.mapmaid.docs.examples.special.annotation.Annotation' " +
                        "cannot be detected because it is an annotation (you can still register it manually)")
