...
package de.quantummaid.mapmaid.docs.examples.serializedobjects.success.injection.nontransient.normalinjection;

import de.quantummaid.mapmaid.docs.examples.serializedobjects.success.injection.nontransient.DtoWithNonTransientInjection;
import de.quantummaid.mapmaid.docs.examples.serializedobjects.success.injection.nontransient.InjectionObject;
...
public final class NormalInjectionExample {
    ...
    public void normalInjectionExample() {
        scenarioBuilderFor(DtoWithNonTransientInjection.class)
                ...
                .withInjection(injector -> injector.put(InjectionObject.injectionObject("foo")))
