...
import de.quantummaid.mapmaid.docs.examples.special.non_static_inner_class.OuterClass.NonStaticInnerClass;
...
public final class NonStaticInnerClassExample {
    ...
    public void nonStaticInnerClassExample() {
        ...
        scenarioBuilderFor(NonStaticInnerClass.class)
                ...
                .withSerializationFailing("type 'de.quantummaid.mapmaid.docs.examples.special.non_static_inner_class.OuterClass$NonStaticInnerClass' " +
                        "cannot be detected because it is a non-static inner class (you can still register it manually)")
                .withDeserializationFailing("type 'de.quantummaid.mapmaid.docs.examples.special.non_static_inner_class.OuterClass$NonStaticInnerClass' " +
                        "cannot be detected because it is a non-static inner class (you can still register it manually)")
                .withDuplexFailing("type 'de.quantummaid.mapmaid.docs.examples.special.non_static_inner_class.OuterClass$NonStaticInnerClass' " +
                        "cannot be detected because it is a non-static inner class (you can still register it manually)")
