...
public final class AnonymousClassExample {
    ...
    public void abstractClassExample() {
        ...
        scenarioBuilderFor(instance.getClass())
                ...
                .withSerializationFailing("type 'de.quantummaid.mapmaid.docs.examples.special.anonymous_class.AnonymousClassExample$1' " +
                        "cannot be detected because it is an anonymous class (you can still register it manually)")
                .withDeserializationFailing("type 'de.quantummaid.mapmaid.docs.examples.special.anonymous_class.AnonymousClassExample$1' " +
                        "cannot be detected because it is an anonymous class (you can still register it manually)")
                .withDuplexFailing("type 'de.quantummaid.mapmaid.docs.examples.special.anonymous_class.AnonymousClassExample$1' " +
                        "cannot be detected because it is an anonymous class (you can still register it manually)")
