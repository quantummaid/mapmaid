...
public final class JacksonMarshallerDocumentationTests {
    ...
    public void yamlMarshallerExample() {
        ...
        final Object deserialized = mapMaid.deserializer().deserializeToUniversalObject(YAML, MarshallingType.YAML);
        assertThat(deserialized, is(MAP));
    }
}
